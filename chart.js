 ...
 */
    ...
    function jt(t) {
        Ht || (Ht = function () {
            const t = {}, e = Object.keys(Wt), i = Object.keys(Nt);
            let s, n, o, a, r;
    ...
    const oe = {
        values: t => n(t) ? t : "" + t, numeric(t, e, i) {
            ...
            const a = z(Math.abs(o)), r = Math.max(Math.min(-1 * Math.floor(a), 20), 0),
    ...
    function Ce(t, e, i, s) {
        ...
        const l = i.length;
        let h, c, d, u, f;
        for (h = 0; h < l; h++) if (u = i[h], null != u && !0 !== n(u)) r = De(t, o, a, r, u); else if (n(u)) for (c = 0, d = u.length; c < d; c++) f = u[c], null == f || n(f) || (r = De(t, o, a, r, f));
        t.restore();
        const g = a.length / 2;
        if (g > i.length) {
        ...
        return new Proxy(a, {
            ...
            get: (t, e, i) => Xe(t, e, (() => function (t, e, i) {
                ...
                n(h) && h.length && (h = function (t, e, i, s) {
                    ...
                    if (k(a.index) && s(t)) e = e[a.index % e.length]; else if (o(e[0])) {
    ...
    function Ze(t, e, i, s) {
        const a = e._rootScopes, r = qe(e._fallback, i, s), l = [...t, ...a], h = new Set;
        h.add(s);
    ...
    const ii = Number.EPSILON || 1e-14, si = (t, e) => e < t.length && !t[e].skip && t[e],
        ni = t => "x" === t ? "y" : "x";
    ...
    function ai(t, e = "x") {
        const i = ni(e), s = t.length, n = Array(s).fill(0), o = Array(s);
        let a, r, l, h = si(t, 0);
        for (a = 0; a < s; ++a) if (r = l, l = h, h = si(t, a + 1), l) {
            if (h) {
                const t = h[e] - l[e];
                n[a] = 0 !== t ? (h[i] - l[i]) / t : 0
            }
    ...
    function li(t, e, i, s, n) {
        let o, a, r, l;
        if (e.spanGaps && (t = t.filter((t => !t.skip))), "monotone" === e.cubicInterpolationMode) ai(t, n); else {
    ...
    const hi = t => 0 === t || 1 === t, ci = (t, e, i) => -Math.pow(2, 10 * (t -= 1)) * Math.sin((t - e) * O / i),
        di = (t, e, i) => Math.pow(2, -10 * t) * Math.sin((t - e) * O / i) + 1, ui = {
            linear: t => t,
            easeInQuad: t => t * t,
            easeOutQuad: t => -t * (t - 2),
    ...
    function pi(t, e, i, s) {
        const n = {x: t.cp2x, y: t.cp2y}, o = {x: e.cp1x, y: e.cp1y}, a = fi(t, n, i), r = fi(n, o, i), l = fi(o, e, i),
            h = fi(a, r, i), c = fi(r, l, i);
        return fi(h, c, i)
    }
    ...
    function Li(t, e, i) {
        ...
        const {property: s, start: n, end: o} = i, a = e.length, {
            ...
            between: l,
            normalize: h
        } = Ai(s), {start: c, end: d, loop: u, style: f} = function (t, e, i) {
    ...
    function Ii(t, e, i, s) {
        return s && s.setContext && i ? function (t, e, i, s) {
            const n = t._chart.getContext(), o = zi(t.options), {_datasetIndex: a, options: {spanGaps: r}} = t,
                l = i.length, h = [];
    ...
    var Yi = {
        evaluateInteractionItems: Ni, modes: {
            index(t, e, i, s) {
                const n = ye(e, t), o = i.axis || "x", a = i.includeInvisible || !1,
                    r = i.intersect ? Wi(t, n, o, s, a) : ji(t, n, o, !1, s, a), l = [];
            ...
            dataset(t, e, i, s) {
                const n = ye(e, t), o = i.axis || "xy", a = i.includeInvisible || !1;
    ...
    function Qi(t, e, i, s) {
        ...
        const l = Math.max(0, e.outerWidth - Zi(r, t, "left", "right")),
            h = Math.max(0, e.outerHeight - Zi(r, t, "top", "bottom")), c = l !== t.w, d = h !== t.h;
    ...
    var ns = {
        addBox(t, e) {
            ...
            if (!t) return;
            const n = Mi(t.options.layout.padding), o = Math.max(e - n.width, 0), a = Math.max(i - n.height, 0),
                r = function (t) {
                    const e = function (t) {
                            const e = [];
                            let i, s, n, o, a, r;
                            ...
                            return e
                        }(t), i = Ki(e.filter((t => t.box.fullSize)), !0), s = Ki(Xi(e, "left"), !0),
                        n = Ki(Xi(e, "right")), o = Ki(Xi(e, "top"), !0), a = Ki(Xi(e, "bottom")), r = qi(e, "x"),
                        l = qi(e, "y");
                    return {
                        fullSize: i,
            ...
            Ji(f, Mi(s));
            const g = Object.assign({maxPadding: f, w: o, h: a, x: n.left, y: n.top}, n), p = Gi(l.concat(h), d);
            es(r.fullSize, g, d, p), es(l, g, d, p), es(h, g, d, p) && es(l, g, d, p), function (t) {
    ...
    function _s(t, e, i) {
        const s = t.canvas, n = ct((e => {
            null !== t.ctx && i(function (t, e) {
                const i = rs[t.type] || t.type, {x: s, y: n} = ye(t, e);
    ...
    class ys extends os {
        acquireContext(t, e) {
            ...
            return i && i.canvas === t ? (function (t, e) {
                ...
                if (ls(s)) if ("" === t.style.height) t.height = t.width / (e || 2); else {
                    const e = Se(t, "height");
                    void 0 !== e && (t.height = e)
                }
            }(t, e), i) : null
        ...
        addEventListener(t, e, i) {
            ...
            const s = t.$proxies || (t.$proxies = {}), n = {attach: us, detach: fs, resize: bs}[e] || _s;
            s[e] = n(t, e, i)
        }
    ...
    const ws = "transparent", ks = {
        boolean: (t, e, i) => i > .5 ? e : t, color(t, e, i) {
            const s = Qt(t || ws), n = s.valid && Qt(e || ws);
    ...
    const zs = t => "reset" === t || "none" === t, Fs = (t, e) => e ? t : Object.assign({}, t);
    ...
    class Vs {
        ...
        linkScales() {
            const t = this.chart, e = this._cachedMeta, i = this.getDataset(),
                s = (t, e, i, s) => "x" === t ? e : "r" === t ? s : i, n = e.xAxisID = l(i.xAxisID, Rs(t, "x")),
                o = e.yAxisID = l(i.yAxisID, Rs(t, "y")), a = e.rAxisID = l(i.rAxisID, Rs(t, "r")), r = e.indexAxis,
    ...
    const Hs = (t, e, i) => "top" === e || "left" === e ? t[e] + i : t[e] - i, js = (t, e) => Math.min(e || t, t);
    ...
    function Xs(t, e) {
        ...
        const i = wi(t.font, e), s = Mi(t.padding);
    ...
    class Ks extends Bs {
        ...
        calculateLabelRotation() {
            const t = this.options, e = t.ticks, i = js(this.ticks.length, t.ticks.maxTicksLimit),
        ...
        _computeGridLineItems(t) {
            const e = this.axis, i = this.chart, s = this.options, {grid: n, position: a, border: r} = s, h = n.offset,
                c = this.isHorizontal(), d = this.ticks.length + (h ? 1 : 0), u = Us(n), f = [],
        ...
        _computeLabelItems(t) {
            const e = this.axis, i = this.options, {position: s, ticks: a} = i, r = this.isHorizontal(),
                l = this.ticks, {align: h, crossAlign: c, padding: d, mirror: u} = a, f = Us(i.grid), g = f + d,
            ...
            for (x = 0, _ = l.length; x < _; ++x) {
                ...
                if (r ? (M = S, "inner" === k && (f = x === _ - 1 ? this.options.reverse ? "left" : "right" : 0 === x ? this.options.reverse ? "right" : "left" : "center"), O = "top" === s ? "near" === c || 0 !== m ? -C * D + D / 2 : "center" === c ? -T.highest.height / 2 - e * D + D : -T.highest.height + D / 2 : "near" === c || 0 !== m ? D / 2 : "center" === c ? T.highest.height / 2 - e * D : T.highest.height - C * D, u && (O *= -1), 0 === m || t.showLabelBackdrop || (M += D / 2 * Math.sin(m))) : (w = S, O = (1 - C) * D / 2), t.showLabelBackdrop) {
                    const e = Mi(t.backdropPadding), i = T.heights[x], s = T.widths[x];
        ...
        drawTitle() {
            ...
            if (!i.display) return;
            const a = wi(i.font), r = Mi(i.padding), l = i.align;
    ...
    class Qs {
        ...
        _createDescriptors(t, e) {
            const i = t && t.config, s = l(i.options && i.options.plugins, {}), n = function (t) {
                const e = {}, i = [], s = Object.keys(Js.plugins.items);
    ...
    function on(t) {
        ...
        e.plugins = l(e.plugins, {}), e.scales = function (t, e) {
            const i = re[t.type] || {scales: {}}, s = e.scales || {}, n = sn(t.type, e), a = Object.create(null);
            return Object.keys(s).forEach((t => {
                ...
                const r = nn(t, e), l = function (t, e) {
                    return t === e ? "_index_" : "_value_"
                }(r, n), h = i.scales || {};
                a[t] = x(Object.create(null), [{axis: r}, e, h[r], h[l]])
            })), t.data.datasets.forEach((i => {
                const n = i.type || t.type, o = i.indexAxis || sn(n, e), r = (re[n] || {}).scales || {};
    ...
    class dn {
        ...
        resolveNamedOptions(t, e, i, s = [""]) {
            const o = {$shared: !0}, {resolver: a, subPrefixes: r} = un(this._resolverCache, t, s);
            let l = a;
            if (function (t, e) {
    ...
    class wn {
        ...
        constructor(t, e) {
            const s = this.config = new dn(e), n = _n(t), o = vn(n);
        ...
        buildOrUpdateScales() {
            ...
            e && (n = n.concat(Object.keys(e).map((t => {
                const i = e[t], s = nn(t, i), n = "r" === s, o = "x" === s;
                return {
                    options: i,
                ...
                const n = e.options, o = n.id, a = nn(o, n), r = l(n.type, e.dtype);
        ...
        buildOrUpdateControllers() {
            ...
            for (this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s; i++) {
                ...
                if (n.type && n.type !== o && (this._destroyDatasetMeta(i), n = this.getDatasetMeta(i)), n.type = o, n.indexAxis = s.indexAxis || sn(o, this.options), n.order = s.order || 0, n.index = i, n.label = "" + s.label, n.visible = this.isDatasetVisible(i), n.controller) n.controller.updateIndex(i), n.controller.linkScales(); else {
                    const e = Js.getController(o), {datasetElementType: s, dataElementType: a} = ue.datasets[o];
                    Object.assign(e, {
    ...
    var Vn = Object.freeze({
        __proto__: null, BarController: class extends Vs {
            static id = "bar";
            static defaults = {
                datasetElementType: !1,
                dataElementType: "bar",
            ...
            _calculateBarValuePixels(t) {
                const {_cachedMeta: {vScale: e, _stacked: i, index: n}, options: {base: o, minBarLength: a}} = this,
                    r = o || 0, l = this.getParsed(t), h = l._custom, c = Tn(h);
        ...
        }, DoughnutController: zn, LineController: class extends Vs {
            static id = "line";
            ...
            updateElements(t, e, i, n) {
                const o = "reset" === n, {
                    ...
                    f = r.axis, {spanGaps: g, segment: p} = this.options, m = W(g) ? g : Number.POSITIVE_INFINITY,
        ...
        }, PolarAreaController: Fn, PieController: class extends zn {
            static id = "pie";
            ...
            updateElements(t, e, i, n) {
                const o = "reset" === n, {iScale: a, vScale: r, _stacked: l, _dataset: h} = this._cachedMeta,
                    ...
                    b = W(p) ? p : Number.POSITIVE_INFINITY, x = this.chart._animationsDisabled || o || "none" === n;
    ...
    function Wn(t, e, i, s, n, o) {
        ...
        const p = (g - Math.max(.001, g * d - i / C) / d) / 2, m = l + p + f, b = n - p - f, {
                ...
                innerStart: y,
                innerEnd: v
            } = Bn(e, u, d, b - m), M = d - x, w = d - _, k = m + x / M, S = b - _ / w, P = u + y, D = u + v, O = m + y / P,
            A = b - v / D;
        if (t.beginPath(), o) {
            const e = (k + S) / 2;
    ...
    class Zn extends Bs {
        ...
        interpolate(t, e) {
            const i = this.options, s = t[e], n = this.points, o = Ei(this, {property: e, start: s, end: s});
            if (!o.length) return;
    ...
    function eo(t) {
        const e = Qn(t), i = e.right - e.left, s = e.bottom - e.top, n = function (t, e, i) {
            const s = t.options.borderWidth, n = t.borderSkipped, o = yi(s);
            return {
            ...
            const {enableBorderRadius: s} = t.getProps(["enableBorderRadius"]), n = t.options.borderRadius, a = vi(n),
    ...
    var oo = Object.freeze({
        __proto__: null, ArcElement: class extends Bs {
            static id = "arc";
            static defaults = {
                borderAlign: "center",
                borderColor: "#fff",
            ...
            inRange(t, e, i) {
                const s = this.getProps(["x", "y"], i), {angle: n, distance: o} = X(s, {x: t, y: e}), {
                    ...
                    u = this.options.spacing / 2, f = l(d, r - a) >= O || Z(n, a, r), g = tt(o, h + u, c + u);
                return f && g
            }
        ...
        }, LineElement: Zn, PointElement: class extends Bs {
            static id = "point";
            static defaults = {
                borderWidth: 1,
                hitRadius: 1,
    ...
    const uo = t => Math.floor(z(t)), fo = (t, e) => Math.pow(10, uo(t) + e);
    ...
    function yo(t) {
        ...
        for (let u = 0; u < a; u++) {
            ...
            o[u] = a.padding;
            const f = t.getPointPosition(u, t.drawingArea + o[u], l), g = wi(a.font),
        ...
        t.setCenterPoint(e.l - i.l, i.r - e.r, e.t - i.t, i.b - e.b), t._pointLabelItems = function (t, e, i) {
            const s = [], n = t._pointLabels.length, o = t.options, a = xo(o) / 2, r = t.drawingArea,
                l = o.pointLabels.centerPointLabels ? C / n : 0;
            for (let o = 0; o < n; o++) {
                const n = t.getPointPosition(o, r + a + i[o], l), h = Math.round(Y(G(n.angle + E))), c = e[o],
                    d = ko(n.y, c.h, h), u = Mo(h), f = wo(n.x, c.w, u);
    ...
    class Po extends ho {
        ...
        setDimensions() {
            const t = this._padding = Mi(xo(this.options) / 2), e = this.width = this.maxWidth - t.width,
        ...
        drawGrid() {
            const t = this.ctx, e = this.options, {angleLines: i, grid: n, border: o} = e, a = this._pointLabels.length;
            let r, l, h;
            if (e.pointLabels.display && function (t, e) {
                const {ctx: i, options: {pointLabels: n}} = t;
                for (let o = e - 1; o >= 0; o--) {
                    const e = n.setContext(t.getPointLabelContext(o)), a = wi(e.font), {
                        x: r,
                        y: l,
                        textAlign: h,
                        left: c,
                    ...
                    if (!s(g)) {
                        const t = vi(e.borderRadius), s = Mi(e.backdropPadding);
                        i.fillStyle = g;
                ...
                if (0 !== e) {
                    ...
                    const i = this.getContext(e), s = n.setContext(i), r = o.setContext(i);
                    !function (t, e, i, s, n) {
                ...
                for (t.save(), r = a - 1; r >= 0; r--) {
                    const s = i.setContext(this.getPointLabelContext(r)), {color: n, lineWidth: o} = s;
        ...
        drawLabels() {
            ...
            t.save(), t.translate(this.xCenter, this.yCenter), t.rotate(s), t.textAlign = "center", t.textBaseline = "middle", this.ticks.forEach(((s, a) => {
                ...
                const r = i.setContext(this.getContext(a)), l = wi(r.font);
    ...
    function To(t, e, i, s) {
        ...
        for (let o = Co.indexOf(t); o < n - 1; ++o) {
            const t = Do[Co[o]], n = t.steps ? t.steps : Number.MAX_SAFE_INTEGER;
    ...
    class Ro extends Ks {
        ...
        _generate() {
            const t = this._adapter, e = this.min, i = this.max, s = this.options, n = s.time,
                o = n.unit || To(n.minUnit, e, i, this._getLabelCapacity(e)), a = l(s.ticks.stepSize, 1),
                r = "week" === o && n.isoWeekday, h = W(r) || !0 === r, c = {};
            let d, u, f = e;
        ...
        _getLabelCapacity(t) {
            const e = this.options.time, i = e.displayFormats, s = i[e.unit] || i.millisecond,
                n = this._tickFormatFunction(t, 0, Eo(this, [t], this._majorUnit), s), o = this._getLabelSize(n),
    ...
    function ta(t, e, i) {
        ...
        for (let n = 0; n < i.length; n++) {
            const o = i[n], {first: a, last: r, point: l} = ea(o, e, "x");
    ...
    function na(t, e, i) {
        const s = sa(e), {line: n, scale: o, axis: a} = e, r = n.options, l = r.fill,
    ...
    function aa(t, e) {
        const {line: i, target: s, property: n, color: o, scale: a} = e, r = function (t, e, i) {
            ...
            for (const t of s) {
                ...
                const h = Ei(e, l);
                for (const e of h) {
                    const s = Xo(i, o[e.start], o[e.end], e.loop), r = Li(t, n, s);
    ...
    class da extends Bs {
        ...
        fit() {
            ...
            const i = t.labels, s = wi(i.font), n = s.size, o = this._computeTitleHeight(), {
                boxWidth: a,
                itemHeight: r
            } = ca(i, n);
            let l, h;
        ...
        adjustHitBoxes() {
            ...
            } = this, o = Di(n, this.left, this.width);
            if (this.isHorizontal()) {
        ...
        _draw() {
            const {options: t, columnSizes: e, lineWidths: i, ctx: s} = this, {align: n, labels: o} = t, a = ue.color,
                r = Di(t.rtl, this.left, this.width), h = wi(o.font), {padding: c} = o, d = h.size, u = d / 2;
            let f;
            this.drawTitle(), s.textAlign = r.textAlign("left"), s.textBaseline = "middle", s.lineWidth = .5, s.font = h.string;
            const {boxWidth: g, boxHeight: p, itemHeight: m} = ca(o, d), b = this.isHorizontal(),
            ...
            this.legendItems.forEach(((y, v) => {
                ...
                if (function (t, e, i) {
                    ...
                    if (s.fillStyle = l(i.fillStyle, a), s.lineCap = l(i.lineCap, "butt"), s.lineDashOffset = l(i.lineDashOffset, 0), s.lineJoin = l(i.lineJoin, "miter"), s.lineWidth = n, s.strokeStyle = l(i.strokeStyle, a), s.setLineDash(l(i.lineDash, [])), o.usePointStyle) {
                        ...
                        const o = e + Math.max((d - p) / 2, 0), a = r.leftForLtr(t, g), l = vi(i.borderRadius);
        ...
        drawTitle() {
            const t = this.options, e = t.title, i = wi(e.font), s = Mi(e.padding);
            if (!e.display) return;
            const n = Di(t.rtl, this.left, this.width), o = this.ctx, a = e.position, r = i.size / 2, l = s.top + r;
        ...
        _computeTitleHeight() {
            const t = this.options.title, e = wi(t.font), i = Mi(t.padding);
            ...
            labels: {
                color: t => t.chart.options.color, boxWidth: 40, padding: 10, generateLabels(t) {
                    ...
                    return t._getSortedDatasetMetas().map((t => {
                        const l = t.controller.getStyle(i ? 0 : void 0), h = Mi(l.borderWidth);
                        return {
    ...
    class ga extends Bs {
        ...
        draw() {
            ...
            if (!e.display) return;
            const i = wi(e.font), s = i.lineHeight / 2 + this._padding.top, {
                titleX: n,
                titleY: o,
                maxWidth: a,
                rotation: r
    ...
    function Ma(t, e) {
        const i = t.chart.ctx, {body: s, footer: n, title: o} = t, {boxWidth: a, boxHeight: r} = e, l = wi(e.bodyFont),
            h = wi(e.titleFont), c = wi(e.footerFont), d = o.length, f = n.length, g = s.length, p = Mi(e.padding);
    ...
    class Ta extends Bs {
        ...
        _resolveAnimations() {
            ...
            const e = this.chart, i = this.options.setContext(this.getContext()),
                s = i.enabled && e.options.animation && i.animations, n = new Ps(this.chart, s);
        ...
        getTitle(t, e) {
            const {callbacks: i} = e, s = Aa(i, "beforeTitle", this, t), n = Aa(i, "title", this, t),
        ...
        getBody(t, e) {
            ...
            return u(t, (t => {
                const e = {before: [], lines: [], after: []}, n = Ca(i, t);
        ...
        getFooter(t, e) {
            const {callbacks: i} = e, s = Aa(i, "beforeFooter", this, t), n = Aa(i, "footer", this, t),
        ...
        update(t, e) {
            ...
            if (s.length) {
                ...
                const e = this._size = Ma(this, i), a = Object.assign({}, t, e), r = ka(this.chart, i, a),
        ...
        getCaretPosition(t, e, i) {
            const {xAlign: s, yAlign: n} = this, {caretSize: o, cornerRadius: a} = i, {
                ...
                bottomLeft: h,
                bottomRight: c
            } = vi(a), {x: d, y: u} = t, {width: f, height: g} = e;
            let p, m, b, x, _, y;
        ...
        _drawColorBox(t, e, i, s, n) {
            const a = this.labelColors[i], r = this.labelPointStyles[i], {boxHeight: l, boxWidth: h, boxPadding: c} = n,
                d = wi(n.bodyFont), u = Pa(this, "left", n), f = s.x(u),
            ...
            if (n.usePointStyle) {
                const e = {radius: Math.min(h, l) / 2, pointStyle: r.pointStyle, rotation: r.rotation, borderWidth: 1},
                    i = s.leftForLtr(f, h) + h / 2, o = p + l / 2;
                ...
                const e = s.leftForLtr(f, h - c), i = s.leftForLtr(s.xPlus(f, 1), h - c - 2), r = vi(a.borderRadius);
        ...
        drawBody(t, e, i) {
            ...
            const g = Di(i.rtl, this.x, this.width), p = function (i) {
        ...
        _updateAnimationTarget(t) {
            ...
            if (s || n) {
                ...
                if (!i) return;
                const o = this._size = Ma(this, t), a = Object.assign({}, i, this._size), r = ka(e, t, a),
                    l = Sa(t, a, r, e);
        ...
        _positionChanged(t, e) {
            const {caretX: i, caretY: s, options: n} = this, o = xa[n.position].call(this, t, e);
